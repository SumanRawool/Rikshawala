...
<body> 
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top navbar-light" >
            ...
            <label class="switch ml-auto">
                <input type="checkbox" id="status" onclick="javascript:changenew(this.checked)" style="display:inline-block;">
...
function changenew(data) {
  //alert(status);
  var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                if (this.readychangeStatus(status)State == 4 && this.status == 200) {
